...
/*
        ...
        document.getElementById ("name").addEventListener("click", function ( event ) {
          api.goto(document.getElementById ("slide2"));
        }, false);


        document.getElementById ("work").addEventListener("click", function ( event ) {
          api.goto(document.getElementById ("slide1"));
        }, false);


  document.getElementById ("contact").addEventListener("click", function ( event ) {
          api.goto(document.getElementById ("slide3"));
        }, false);


  document.getElementById ("blog").addEventListener("click", function ( event ) {
          api.goto(document.getElementById ("slide4"));
        }, false);

  document.getElementById ("aboutWebiste").addEventListener("click", function ( event ) {
          api.goto(document.getElementById ("slide5"));
        }, false);

  document.getElementById ("back1").addEventListener("click", function ( event ) {
          api.goto(document.getElementById ("slide0"));
        }, false);
